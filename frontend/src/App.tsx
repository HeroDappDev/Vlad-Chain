    ...
    <div style={{
      ...
      <div className="app-header" style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div className="nav-tabs">
          ...
          <a
            className="nav-tab-button"
            href="https://github.com/HeroDappDev/Vlad-Chain"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            <svg width="18" height="18" viewBox="0 0 16 16" fill="currentColor" style={{ filter: 'drop-shadow(0 0 3px #CBFA03)' }} aria-label="GitHub">
